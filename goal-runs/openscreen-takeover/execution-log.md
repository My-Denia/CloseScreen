...
- 2026-06-11: Triggered `build.yml` run `27366037433` (`https://github.com/My-Denia/openscreen/actions/runs/27366037433`). Windows job succeeded and uploaded `windows-installer` size `386907333`; Linux failed in `.deb` packaging because maintainer email was missing.
